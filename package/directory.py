...
from utilities.string_operations import reverse_string as reverse_string, capitalize_string, lowercase_string, uppercase_string

print("Using calculator.py:")
print("Addition", add_def(10,5))
print("Subtraction:", subtract_def(10,5))
print("Multiplcation:", multiply_def(10,5))
